...
const MENU_ITEMS = [
  { label: '目标设定', path: '/profile/settings/goal' },
  { label: '隐私设置', path: '/profile/settings/privacy' },
  { label: '提醒通知', path: '/profile/settings/reminders' },
  { label: '连接设备', path: '/profile/settings/device' },
  { label: '关于我们', path: '/profile/settings/about' },
];
